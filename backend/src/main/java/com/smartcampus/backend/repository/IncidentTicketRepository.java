...
public interface IncidentTicketRepository extends JpaRepository<IncidentTicket, Long> {
    ...
    Page<IncidentTicket> findByReporter_IdAndStatusAndPriority(Long reporterId, String status, String priority,
            Pageable pageable);
    ...
    Page<IncidentTicket> findByCreatedAtBetween(java.time.LocalDateTime start, java.time.LocalDateTime end,
            Pageable pageable);
